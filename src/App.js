...
function App() {
  ...
  useEffect(() => {
    // console.log("Color is now red? ", isRed);
    // console.log("Color is now orange? ", isOrange);
    // console.log("Color is now brown? ", isBrown);
    // console.log("Color is now light brown? ", isLightBrown);
    // console.log("Color is now yellow? ", isYellow);
    const feaColors = [];
    if (isRed) feaColors.push("red");
    if (isOrange) feaColors.push("orange");
    if (isBrown) feaColors.push("brown");
    if (isLightBrown) feaColors.push("light-brown");
    if (isYellow) feaColors.push("yellow");
    console.log(feaColors);
    setFeatherColors(feaColors);
